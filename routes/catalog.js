...
router.get('/incident+people/create', incident_controller && people_controller.incident_create_post + people_create_post);
...
router.get('/incident+people/delete', incident_controller && people_controller.incident_delete_post + people_delete_post);
...
router.get('/incident+people/update', incident_controller && people_controller.incident_update_post + people_update_post);
